...
(()=>{
    ...
    var io = (e,t)=>{
        var r = {};
        for (var o in e)
            xr.call(e, o) && t.indexOf(o) < 0 && (r[o] = e[o]);
        if (e != null && Dt)
            for (var o of Dt(e))
    ...
    ;
    var Vt = (e,t,r)=>(r = e != null ? Fi(Ui(e)) : {},
    Di(t || !e || !e.__esModule ? gr(r, "default", {
        value: e,
        enumerable: !0
    }) : r, e));
    var ao = (e,t,r)=>new Promise((o,n)=>{
        var i = p=>{
            try {
                s(r.next(p))
            } catch (c) {
    ...
    var co = yr((Er,so)=>{
        (function(e, t) {
            typeof Er == "object" && typeof so != "undefined" ? t() : typeof define == "function" && define.amd ? define(t) : t()
        }
        )(Er, function() {
            "use strict";
            function e(r) {
                ...
                function p(H) {
                    var lt = H.type
                      , ze = H.tagName;
                    return !!(ze === "INPUT" && a[lt] && !H.readOnly || ze === "TEXTAREA" && !H.readOnly || H.isContentEditable)
                }
                function c(H) {
                    H.classList.contains("focus-visible") || (H.classList.add("focus-visible"),
                    H.setAttribute("data-focus-visible-added", ""))
                }
                function l(H) {
                    H.hasAttribute("data-focus-visible-added") && (H.classList.remove("focus-visible"),
                    H.removeAttribute("data-focus-visible-added"))
                }
                function f(H) {
                    H.metaKey || H.altKey || H.ctrlKey || (s(r.activeElement) && c(r.activeElement),
                    o = !0)
                }
                function u(H) {
                    o = !1
                ...
                function w(H) {
                    s(H.target) && (H.target.classList.contains("focus-visible") || H.target.hasAttribute("data-focus-visible-added")) && (n = !0,
                ...
                function J(H) {
                    H.target.nodeName && H.target.nodeName.toLowerCase() === "html" || (o = !1,
                    ie())
                }
 ...
 */
        (function(t, r) {
            typeof Rt == "object" && typeof Kr == "object" ? Kr.exports = r() : typeof define == "function" && define.amd ? define([], r) : typeof Rt == "object" ? Rt.ClipboardJS = r() : t.ClipboardJS = r()
        }
        )(Rt, function() {
            return function() {
                var e = {
                    686: function(o, n, i) {
                        ...
                        function A(V) {
                            ...
                            return O.style.top = "".concat(j, "px"),
                        ...
                        var te = function(_, O) {
                          ...
                          , ie = function(_) {
                            var O = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {
                              ...
                              , j = "";
                            return typeof _ == "string" ? j = te(_, O) : _ instanceof HTMLInputElement && !["text", "search", "url", "tel", "password"].includes(_ == null ? void 0 : _.type) ? j = te(_.value, O) : (j = f()(_),
                            u("copy")),
                            j
                        }
                          , J = ie;
                        ...
                        var lt = function() {
                            ...
                            if (Y !== void 0)
                                if (Y && H(Y) === "object" && Y.nodeType === 1) {
                                    ...
                                    if (j === "cut" && (Y.hasAttribute("readonly") || Y.hasAttribute("disabled")))
                        ...
                        function Ie(V) {
                            "@babel/helpers - typeof";
                            return typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? Ie = function(O) {
                                return typeof O
                            }
                            : Ie = function(O) {
                                return O && typeof Symbol == "function" && O.constructor === Symbol && O !== Symbol.prototype ? "symbol" : typeof O
                        ...
                        function br(V, _) {
                            return br = Object.setPrototypeOf || function(j, D) {
                                return j.__proto__ = D,
                                j
                            }
                            ,
                            br(V, _)
                        ...
                        function Hi(V) {
                            ...
                            return function() {
                                ...
                                if (_) {
                                    ...
                                    D = j.apply(this, arguments);
                                return ki(this, D)
                            }
                        }
                        function ki(V, _) {
                            return _ && (Ie(_) === "object" || typeof _ == "function") ? _ : $i(V)
                        }
                        function $i(V) {
                            if (V === void 0)
                        ...
                        function Wt(V) {
                            return Wt = Object.setPrototypeOf ? Object.getPrototypeOf : function(O) {
                        ...
                        var Ri = function(V) {
                            ...
                            return Ai(O, [{
                                ...
                                value: function() {
                                    ...
                                    this.container = Ie(D.container) === "object" ? D.container : document.body
                                }
                            }, {
                                key: "listenClick",
                                value: function(D) {
                    ...
                    438: function(o, n, i) {
                        ...
                        function s(l, f, u, h, w) {
                            ...
                            return l.addEventListener(u, A, w),
                            {
                                destroy: function() {
                    ...
                    370: function(o, n, i) {
                        ...
                        function l(u, h, w) {
                            return Array.prototype.forEach.call(u, function(A) {
...
***************************************************************************** */
    ...
    function ot(e) {
        return this instanceof ot ? (this.v = e,
        this) : new ot(e)
    }
    function lo(e, t, r) {
        ...
        function p(u) {
            u.value instanceof ot ? Promise.resolve(u.value.v).then(c, l) : f(i[0][2], u)
        }
        function c(u) {
            s("next", u)
        }
    ...
    function mo(e) {
        ...
        return t ? t.call(e) : (e = typeof de == "function" ? de(e) : e[Symbol.iterator](),
        r = {},
        o("next"),
        o("throw"),
        o("return"),
...
` + r.map(function(o, n) {
  ...
  `) : "",
                    ...
                    try {
                        for (var u = de(f), h = u.next(); !h.done; h = u.next()) {
                            ...
                            try {
                                ...
                                i = i != null ? i : [],
                                A instanceof zt ? i = q(q([], N(i)), N(A.errors)) : i.push(A)
                            }
                        }
                    } catch (A) {
                        o = {
    ...
    var ft = {
        setTimeout: function(e, t) {
            for (var r = [], o = 2; o < arguments.length; o++)
                r[o - 2] = arguments[o];
            var n = ft.delegate;
            return n != null && n.setTimeout ? n.setTimeout.apply(n, q([e, t], N(r))) : setTimeout.apply(void 0, q([e, t], N(r)))
        },
    ...
    function vo(e) {
        $e.useDeprecatedSynchronousErrorHandling && nt && (nt.errorThrown = !0,
        nt.error = e)
    }
    var Mt = function(e) {
        re(t, e);
        ...
        t.prototype.error = function(r) {
            this.isStopped ? Mr(ho(r), this) : (this.isStopped = !0,
            this._error(r))
        }
        ,
        t.prototype.complete = function() {
            this.isStopped ? Mr(uo, this) : (this.isStopped = !0,
            this._complete())
        }
        ,
      ...
      , it = function(e) {
        ...
        function t(r, o, n) {
            ...
            if (k(r) || !r)
                ...
                var s;
                i && $e.useDeprecatedNextContext ? (s = Object.create(r),
    ...
    function xo(e) {
        var t;
        return (t = e != null ? e : $e.Promise) !== null && t !== void 0 ? t : Promise
    }
    function Qi(e) {
    ...
    var ht = {
        ...
        requestAnimationFrame: function() {
            for (var e = [], t = 0; t < arguments.length; t++)
                e[t] = arguments[t];
            var r = ht.delegate;
            return ((r == null ? void 0 : r.requestAnimationFrame) || requestAnimationFrame).apply(void 0, q([], N(e)))
        },
        cancelAnimationFrame: function() {
            for (var e = [], t = 0; t < arguments.length; t++)
                e[t] = arguments[t];
            var r = ht.delegate;
            return ((r == null ? void 0 : r.cancelAnimationFrame) || cancelAnimationFrame).apply(void 0, q([], N(e)))
        },
        delegate: void 0
    };
        ...
        t.prototype.next = function(r) {
            ...
            ut(function() {
                ...
                !o.isStopped) {
                    ...
                    try {
                        for (var a = de(o.currentObservers), s = a.next(); !s.done; s = a.next()) {
                            var p = s.value;
                            p.next(r)
                        }
                    } catch (c) {
    ...
    var At = {
        setInterval: function(e, t) {
            for (var r = [], o = 2; o < arguments.length; o++)
                r[o - 2] = arguments[o];
            var n = At.delegate;
            return n != null && n.setInterval ? n.setInterval.apply(n, q([e, t], N(r))) : setInterval.apply(void 0, q([e, t], N(r)))
        },
    ...
    var Oo = function(e) {
        ...
        return t.prototype.requestAsyncId = function(r, o, n) {
            ...
            r._scheduled || (r._scheduled = ht.requestAnimationFrame(function() {
        ...
        t.prototype.recycleAsyncId = function(r, o, n) {
            ...
            var a = r.actions;
            o != null && ((i = a[a.length - 1]) === null || i === void 0 ? void 0 : i.id) !== o && (ht.cancelAnimationFrame(o),
            r._scheduled = void 0)
        }
        ,
        t
    ...
    function z() {
        ...
        if (i.length === 0)
            return ue([], r);
        var s = new F(Pr(i, r, a ? function(p) {
            return Io(a, p)
        }
        : le));
    ...
    function jo(e, t, r, o, n, i, a, s) {
        var p = []
          ...
          , w = function(A) {
            ...
            c++;
            var te = !1;
            W(r(A, l++)).subscribe(T(t, function(ie) {
                n == null || n(ie),
                i ? h(ie) : t.next(ie)
            }, function() {
                te = !0
        ...
        return e.subscribe(T(t, h, function() {
            f = !0,
            u()
        })),
        function() {
    ...
    function d(e, t, r, o) {
        ...
        r = void 0),
        o)
            return d(e, t, r).pipe(Ze(o));
        var n = N(ha(e) ? ma.map(function(s) {
            return function(p) {
                return e[s](t, p, r)
            }
        }) : ua(e) ? la.map(Uo(e, t)) : da(e) ? fa.map(Uo(e, t)) : [], 2)
          , i = n[0]
          , a = n[1];
        if (!i && gt(e))
    ...
    function ar(e, t, r) {
        return r ? ar(e, t).pipe(Ze(r)) : new F(function(o) {
            var n = function() {
    ...
    function S() {
        ...
        var r = He(e)
          , o = Bt(e, 1 / 0)
          , n = e;
        return n.length ? n.length === 1 ? W(n[0]) : xt(o)(ue(n, r)) : M
    }
    var Ke = new F(he);
    ...
    function Ct() {
        ...
        var r = Xe(e)
          , o = yt(e);
        return o.length ? new F(function(n) {
            ...
            for (var s = function(c) {
                W(o[c]).subscribe(T(n, function(l) {
                    if (i[c].push(l),
                    i.every(function(u) {
                        return u.length
                    })) {
    ...
    function Rr() {
        for (var e = [], t = 0; t < arguments.length; t++)
            e[t] = arguments[t];
        var r = Xe(e);
        return r ? go(Rr.apply(void 0, q([], N(e))), Ze(r)) : x(function(o, n) {
            Pr(q([o], N(yt(e))))(n)
        })
    }
    function We() {
    ...
    function Ir(e, t) {
        return t ? function(r) {
            return je(t.pipe(we(1), X()), r.pipe(Ir(e)))
        }
        : oe(function(r, o) {
            return W(e(r, o)).pipe(we(1), No(r))
        })
    }
    function Ge(e, t) {
        t === void 0 && (t = se);
    ...
    function jr(e, t) {
        return x(Vo(e, t, arguments.length >= 2, !0))
    }
    function pe(e) {
        e === void 0 && (e = {});
        var t = e.connector
        ...
        : t
          ...
          , p = s === void 0 ? !0 : s;
        return function(c) {
            var l, f, u, h = 0, w = !1, A = !1, te = function() {
    ...
    function v(e, t) {
        return x(function(r, o) {
            ...
            r.subscribe(T(o, function(p) {
                ...
                var c = 0
                  , l = i++;
                W(e(p, l)).subscribe(n = T(o, function(f) {
    ...
    function ee() {
        ...
        return x(function(o, n) {
            for (var i = e.length, a = new Array(i), s = e.map(function() {
                ...
                W(e[f]).subscribe(T(n, function(u) {
                    a[f] = u,
                    !p && !s[f] && (s[f] = !0,
                    (p = s.every(le)) && (s = null))
                }, he))
    ...
    function Yo() {
        let e = new _t(1);
        return d(document, "DOMContentLoaded", {
            once: !0
    ...
    var xa = S(d(document.body, "focusin"), d(document.body, "focusout")).pipe(_e(1), Q(void 0), m(()=>Re() || document.body), B(1));
    function et(e) {
        return xa.pipe(m(t=>e.contains(t)), K())
    }
    function kt(e, t) {
        return C(()=>S(d(e, "mouseenter").pipe(m(()=>!0)), d(e, "mouseleave").pipe(m(()=>!1))).pipe(t ? Ht(r=>Me(+!r * t)) : le, Q(e.matches(":hover"))))
    }
    function Bo(e, t) {
    ...
    function Et(e) {
        ...
        S(d(t, "load"), d(t, "error").pipe(v(()=>$r(()=>new ReferenceError(`Invalid script: ${e}`))))).pipe(m(()=>{}
        ), L(()=>document.head.removeChild(t)), we(1))))
    }
    var Go = new g
      , ya = C(()=>typeof ResizeObserver == "undefined" ? Et("https://unpkg.com/resize-observer-polyfill") : I(void 0)).pipe(m(()=>new ResizeObserver(e=>e.forEach(t=>Go.next(t)))), v(e=>S(Ke, I(e)).pipe(L(()=>e.disconnect()))), B(1));
    function ce(e) {
        return {
            width: e.offsetWidth,
    ...
    function ge(e) {
        ...
        for (; t.clientWidth === 0 && t.parentElement; )
            t = t.parentElement;
        return ya.pipe(y(r=>r.observe(t)), v(r=>Go.pipe(b(o=>o.target === t), L(()=>r.unobserve(t)))), m(()=>ce(e)), Q(ce(e)))
    }
    function wt(e) {
        return {
            width: e.scrollWidth,
    ...
    function Zo(e) {
        return S(d(window, "load"), d(window, "resize")).pipe(Le(0, me), m(()=>Ue(e)), Q(Ue(e)))
    }
    function pr(e) {
        return {
            x: e.scrollLeft,
    ...
    function De(e) {
        return S(d(e, "scroll"), d(window, "scroll"), d(window, "resize")).pipe(Le(0, me), m(()=>pr(e)), Q(pr(e)))
    }
    var en = new g
      , Ea = C(()=>I(new IntersectionObserver(e=>{
        for (let t of e)
            en.next(t)
    }
    ,{
        threshold: 0
    }))).pipe(v(e=>S(Ke, I(e)).pipe(L(()=>e.disconnect()))), B(1));
    function Tt(e) {
        return Ea.pipe(y(t=>t.observe(e)), v(t=>en.pipe(b(({target: r})=>r === e), L(()=>t.unobserve(e)), m(({isIntersecting: r})=>r))))
    }
    function tn(e, t=16) {
        return De(e).pipe(m(({y: r})=>{
            let o = ce(e)
              , n = wt(e);
    ...
    function Ve(e) {
        let t = lr[e];
        return d(t, "change").pipe(m(()=>t.checked), Q(t.checked))
    }
    function wa(e, t) {
    ...
    function Ta() {
        return S(d(window, "compositionstart").pipe(m(()=>!0)), d(window, "compositionend").pipe(m(()=>!1))).pipe(Q(!1))
    }
    function on() {
        let e = d(window, "keydown").pipe(b(t=>!(t.metaKey || t.ctrlKey)), m(t=>({
    ...
    function Sa(e) {
        return S(d(window, "hashchange"), e).pipe(m(an), Q(an()), b(t=>t.length > 0), B(1))
    }
    function cn(e) {
        return Sa(e).pipe(m(t=>fe(`[id="${t}"]`)), b(t=>typeof t != "undefined"))
    }
    function $t(e) {
        let t = matchMedia(e);
    ...
    function pn() {
        ...
        return S(d(window, "beforeprint").pipe(m(()=>!0)), d(window, "afterprint").pipe(m(()=>!1))).pipe(Q(e.matches))
    }
    function Nr(e, t) {
        return e.pipe(v(r=>r ? t() : M))
    }
    function zr(e, t) {
        return new F(r=>{
    ...
    function Ne(e, t) {
        return zr(e, t).pipe(v(r=>r.text()), m(r=>JSON.parse(r)), B(1))
    }
    function ln(e, t) {
        let r = new DOMParser;
        return zr(e, t).pipe(v(o=>o.text()), m(o=>r.parseFromString(o, "text/html")), B(1))
    }
    function mn(e, t) {
        let r = new DOMParser;
        return zr(e, t).pipe(v(o=>o.text()), m(o=>r.parseFromString(o, "text/xml")), B(1))
    }
    function fn() {
        return {
    ...
    function hn() {
        return d(window, "resize", {
            passive: !0
        }).pipe(m(dn), Q(dn()))
    }
    function bn() {
        return z([un(), hn()]).pipe(m(([e,t])=>({
            offset: e,
            size: t
        })), B(1))
    }
    function mr(e, {viewport$: t, header$: r}) {
        let o = t.pipe(Z("size"))
          , n = z([o, r]).pipe(m(()=>Ue(e)));
        return z([r, t, n]).pipe(m(([{height: i},{offset: a, size: s},{x: p, y: c}])=>({
            offset: {
                x: a.x - p,
                y: a.y - c + i
            },
    ...
    function _a(e) {
        ...
        return d(t, "click", {
            once: !0
        }).pipe(m(()=>P(".md-typeset", e)), m(r=>({
            hash: __md_hash(r.innerHTML)
        })))
    }
    function gn(e) {
        if (!G("announce.dismiss") || !e.childElementCount)
            return M;
        if (!e.hidden) {
        ...
        return C(()=>{
            ...
            _a(e).pipe(y(r=>t.next(r)), L(()=>t.complete()), m(r=>R({
                ref: e
            }, r)))
        }
        )
    ...
    function xn(e, t) {
        ...
        Aa(e, t).pipe(y(o=>r.next(o)), L(()=>r.complete()), m(o=>R({
            ref: e
        }, o)))
    }
    function Pt(e, t) {
        return t === "inline" ? E("div", {
    ...
    function qr(e, t) {
        let r = t & 2
          , o = t & 1
          , n = Object.keys(e.terms).filter(p=>!e.terms[p]).reduce((p,c)=>[...p, E("del", null, c), " "], []).slice(0, -1)
          , i = Te()
          , a = new URL(e.location,i.base);
        G("search.highlight") && a.searchParams.set("h", Object.entries(e.terms).filter(([,p])=>p).reduce((p,[c])=>`${p} ${c}`.trim(), ""));
        let {tags: s} = Te();
        return E("a", {
            href: `${a}`,
        ...
        }), r > 0 && E("h1", null, e.title), r <= 0 && E("h2", null, e.title), o > 0 && e.text.length > 0 && e.text, e.tags && e.tags.map(p=>{
    ...
    function Tn(e) {
        ...
        let s = r.slice(0, a)
          , p = r.slice(a)
          , c = [qr(i, 2 | +(!n && a === 0)), ...s.map(l=>qr(l, 1)), ...p.length ? [E("details", {
            class: "md-search-result__more"
        }, E("summary", {
            tabIndex: -1
        }, E("div", null, p.length > 0 && p.length === 1 ? ye("search.result.more.one") : ye("search.result.more.other", p.length))), ...p.map(l=>qr(l, 1)))] : []];
        return E("li", {
    ...
    var Ha = 0;
    function ka(e) {
        let t = z([et(e), kt(e)]).pipe(m(([o,n])=>o || n), K())
          , r = C(()=>Jo(e)).pipe(oe(De), st(1), m(()=>Xo(e)));
        return t.pipe(Ae(o=>o), v(()=>z([t, r])), m(([o,n])=>({
            active: o,
            offset: n
        })), pe())
    }
    function $a(e, t) {
        ...
        return C(()=>{
            ...
            let s = a.pipe(Ht(c=>Me(+!c * 250, Hr)), K(), v(c=>c ? r : M), y(c=>c.id = n), pe());
            z([i.pipe(m(({active: c})=>c)), s.pipe(v(c=>kt(c, 250)), Q(!1))]).pipe(m(c=>c.some(l=>l))).subscribe(a);
            let p = a.pipe(b(c=>c), ee(s, o), m(([c,l,{size: f}])=>{
            ...
            return z([s, i, p]).subscribe(([c,{offset: l},f])=>{
            ...
            a.pipe(b(c=>c), ee(s, (c,l)=>l), b(c=>c.role === "tooltip")).subscribe(c=>{
                let l = ce(P(":scope > *", c));
            ...
            ka(e).pipe(y(c=>i.next(c)), L(()=>i.complete()), m(c=>R({
                ref: e
            }, c)))
        }
        )
    }
    function pt(e, {viewport$: t}, r=document.body) {
        return $a(e, {
            content$: new F(o=>{
                let n = e.title
                  , i = yn(n);
    ...
    function Pa(e, t) {
        let r = C(()=>z([Zo(e), De(t)])).pipe(m(([{x: o, y: n},i])=>{
    ...
    function Ln(e, t, {target$: r}) {
        ...
        return C(()=>{
            ...
            Tt(e).pipe(U(a)).subscribe(s=>{
                e.toggleAttribute("data-md-visible", s)
            }
            ),
            S(i.pipe(b(({active: s})=>s)), i.pipe(_e(250), b(({active: s})=>!s))).subscribe({
                next({active: s}) {
            ...
            i.pipe(st(125, me), b(()=>!!e.offsetParent), m(()=>e.offsetParent.getBoundingClientRect()), m(({x: s})=>s)).subscribe({
                next(s) {
            ...
            d(n, "click").pipe(U(a), b(s=>!(s.metaKey || s.ctrlKey))).subscribe(s=>{
                s.stopPropagation(),
                s.preventDefault()
            }
            ),
            d(n, "mousedown").pipe(U(a), ee(i)).subscribe(([s,{active: p}])=>{
                var c;
                if (s.button !== 0 || s.metaKey || s.ctrlKey)
                    ...
                    l instanceof HTMLElement ? l.focus() : (c = Re()) == null || c.blur()
                }
            }
            ),
            r.pipe(U(a), b(s=>s === o), Ge(125)).subscribe(()=>e.focus()),
            Pa(e, t).pipe(y(s=>i.next(s)), L(()=>i.complete()), m(s=>R({
                ref: e
            }, s)))
        }
        )
    ...
    function fr(e, t, {target$: r, print$: o}) {
        ...
        for (let s of Ia(t)) {
            ...
            fe(`:scope > li:nth-child(${p})`, e) && (a.set(p, En(p, i)),
    ...
    function $n(e, t) {
        let {matches: r} = matchMedia("(hover)")
          , o = C(()=>{
            ...
            let a = [];
            if (Hn.default.isSupported() && (e.closest(".copy") || G("content.code.copy") && !e.closest(".no-copy"))) {
                let c = e.closest("pre");
                c.id = `__code_${Fa++}`;
                let l = wn(c.id);
                c.insertBefore(l, e),
                G("content.tooltips") && a.push(pt(l, {
                    viewport$
                }))
            }
            ...
            if (s instanceof HTMLElement) {
                let c = kn(s);
                if (typeof c != "undefined" && (s.classList.contains("annotate") || G("content.code.annotate"))) {
                    let l = fr(c, e, t);
                    a.push(ge(s).pipe(U(i), m(({width: f, height: u})=>f && u), K(), v(f=>f ? l : M)))
                }
            }
            return $(":scope > span[id]", e).length && e.classList.add("md-code__content"),
            ja(e).pipe(y(c=>n.next(c)), L(()=>n.complete()), m(c=>R({
                ref: e
            }, c)), Pe(...a))
        }
        );
        return G("content.lazy") ? Tt(e).pipe(b(n=>n), we(1), v(()=>o)) : o
    }
    function Wa(e, {target$: t, print$: r}) {
        let o = !0;
        return S(t.pipe(m(n=>n.closest("details:not([open])")), b(n=>e === n), m(()=>({
            action: "open",
            reveal: !0
        }))), r.pipe(b(n=>n || !o), y(()=>o = e.open), m(n=>({
            action: n ? "open" : "close"
        }))))
    }
    function Pn(e, t) {
    ...
    function In(e) {
        ...
        Br.subscribe(()=>ao(this, null, function*() {
    ...
    function Na(e) {
        ...
        return S(...e.map(r=>d(r, "change").pipe(m(()=>P(`label[for="${r.id}"]`))))).pipe(Q(P(`label[for="${t.id}"]`)), m(r=>({
            active: r
        })))
    }
    function Wn(e, {viewport$: t, target$: r}) {
        ...
        C(()=>{
            let s = new g
              , p = s.pipe(X(), ne(!0));
            z([s, ge(e)]).pipe(U(p), Le(1, me)).subscribe({
                next([{active: c},l]) {
                    let f = Ue(c)
                      , {width: u} = ce(c);
                    ...
                    let h = pr(o);
                    (f.x < h.x || f.x + u > h.x + l.width) && o.scrollTo({
            ...
            z([De(o), ge(o)]).pipe(U(p)).subscribe(([c,l])=>{
                let f = wt(o);
                i.hidden = c.x < 16,
                a.hidden = c.x > f.width - l.width - 16
            }
            ),
            S(d(i, "click").pipe(m(()=>-1)), d(a, "click").pipe(m(()=>1))).pipe(U(p)).subscribe(c=>{
                let {width: l} = ce(o);
                o.scrollBy({
                    left: l * c,
                    behavior: "smooth"
            ...
            r.pipe(U(p), b(c=>n.includes(c))).subscribe(c=>c.click()),
            o.classList.add("tabbed-labels--linked");
            for (let c of n) {
                let l = P(`label[for="${c.id}"]`);
                l.replaceChildren(E("a", {
                    href: `#${l.htmlFor}`,
                    tabIndex: -1
                }, ...Array.from(l.childNodes))),
                d(l.firstElementChild, "click").pipe(U(p), b(f=>!(f.metaKey || f.ctrlKey)), y(f=>{
                    f.preventDefault(),
                    f.stopPropagation()
                }
                )).subscribe(()=>{
            ...
            return G("content.tabs.link") && s.pipe(Ce(1), ee(t)).subscribe(([{active: c},{offset: l}])=>{
                    ...
                    for (let w of $("[data-tabs]"))
                        for (let A of $(":scope > input", w)) {
                            ...
                            if (te !== c && te.innerText.trim() === f) {
                                te.setAttribute("data-md-switching", ""),
                                A.click();
                                break
                            }
                        }
            ...
            s.pipe(U(p)).subscribe(()=>{
                for (let c of $("audio, video", e))
                    c.pause()
            }
            ),
            Na(n).pipe(y(c=>s.next(c)), L(()=>s.complete()), m(c=>R({
                ref: e
            }, c)))
        }
        ).pipe(Qe(se))
    ...
    function Un(e, {viewport$: t, target$: r, print$: o}) {
        return S(...$(".annotate:not(.highlight)", e).map(n=>Cn(n, {
            target$: r,
            print$: o
        })), ...$("pre:not(.mermaid) > code", e).map(n=>$n(n, {
            target$: r,
            print$: o
        })), ...$("pre.mermaid", e).map(n=>In(n)), ...$("table:not([class])", e).map(n=>jn(n)), ...$("details", e).map(n=>Pn(n, {
            target$: r,
            print$: o
        })), ...$("[data-tabs]", e).map(n=>Wn(n, {
            viewport$: t,
            target$: r
        })), ...$("[title]", e).filter(()=>G("content.tooltips")).map(n=>pt(n, {
            viewport$: t
        })))
    }
    function za(e, {alert$: t}) {
        return t.pipe(v(r=>S(I(!0), I(!1).pipe(Ge(2e3))).pipe(m(o=>({
            message: r,
            active: o
        })))))
    }
    function Dn(e, t) {
        ...
        return C(()=>{
            ...
            za(e, t).pipe(y(n=>o.next(n)), L(()=>o.complete()), m(n=>R({
                ref: e
            }, n)))
        }
        )
    ...
    function Qa(e, t) {
        ...
        e.remove();
        let o = cr(t)
          , n = typeof o != "undefined" ? De(o) : I({
            x: 0,
            y: 0
        })
          , i = S(et(t), kt(t)).pipe(K());
        return z([i, n]).pipe(m(([a,s])=>{
            let {x: p, y: c} = Ue(t)
              , l = ce(t)
              , f = t.closest("table");
    ...
    function Vn(e) {
        ...
        C(()=>{
            ...
            S(i.pipe(b(({active: a})=>a)), i.pipe(_e(250), b(({active: a})=>!a))).subscribe({
                next({active: a}) {
            ...
            i.pipe(st(125, me), b(()=>!!e.offsetParent), m(()=>e.offsetParent.getBoundingClientRect()), m(({x: a})=>a)).subscribe({
                next(a) {
            ...
            Qa(o, e).pipe(y(a=>i.next(a)), L(()=>i.complete()), m(a=>R({
                ref: e
            }, a)))
        }
        ).pipe(Qe(se))
    ...
    function Ka({viewport$: e}) {
        if (!G("header.autohide"))
            return I(!1);
        let t = e.pipe(m(({offset: {y: n}})=>n), Ye(2, 1), m(([n,i])=>[n < i, i]), Z(0))
          , r = z([e, t]).pipe(b(([{offset: n},[,i]])=>Math.abs(i - n.y) > 100), m(([,[n]])=>n), K())
          , o = Ve("search");
        return z([e, o]).pipe(m(([{offset: n},i])=>n.y > 400 && !i), K(), v(n=>n ? r : I(!1)), Q(!1))
    }
    function Nn(e, t) {
        return C(()=>z([ge(e), Ka(t)])).pipe(m(([{height: r},o])=>({
            height: r,
            hidden: o
        })), K((r,o)=>r.height === o.height && r.hidden === o.hidden), B(1))
    }
    function zn(e, {header$: t, main$: r}) {
        return C(()=>{
            ...
            let i = ue($("[title]", e)).pipe(b(()=>G("content.tooltips")), oe(a=>Vn(a)));
            return r.subscribe(o),
            t.pipe(U(n), m(a=>R({
                ref: e
            }, a)), Pe(i.pipe(U(n))))
    ...
    function qn(e, t) {
        return C(()=>{
            ...
            return typeof o == "undefined" ? M : Ya(o, t).pipe(y(n=>r.next(n)), L(()=>r.complete()), m(n=>R({
                ref: e
            }, n)))
        }
        )
    ...
    function Qn(e, {viewport$: t, header$: r}) {
        ...
        return z([o, n, t]).pipe(m(([i,{top: a, bottom: s},{offset: {y: p}, size: {height: c}}])=>(c = Math.max(0, c - Math.max(0, a - p, i) - Math.max(0, c + p - s)),
        {
            offset: a - i,
            height: c,
            active: a - i <= p
    ...
    function Ba(e) {
        ...
        return I(...e).pipe(oe(o=>d(o, "change").pipe(m(()=>o))), Q(e[r]), m(o=>({
            index: e.indexOf(o),
            color: {
    ...
    function Kn(e) {
        ...
        return C(()=>{
            ...
            d(e, "keydown").pipe(b(a=>a.key === "Enter"), ee(i, (a,s)=>s)).subscribe(({index: a})=>{
                a = (a + 1) % t.length,
                t[a].click(),
                t[a].focus()
            }
            ...
            Ba(t).pipe(U(n.pipe(Ce(1))), at(), y(a=>i.next(a)), L(()=>i.complete()), m(a=>R({
                ref: e
            }, a)))
        }
        )
    ...
    function Bn({alert$: e}) {
        Gr.default.isSupported() && new F(t=>{
            new Gr.default("[data-clipboard-target], [data-clipboard-text]",{
                text: r=>r.getAttribute("data-clipboard-text") || Ga(P(r.getAttribute("data-clipboard-target")))
            }).on("success", r=>t.next(r))
        }
        ).pipe(y(t=>{
            t.trigger.focus()
        }
        ), m(()=>ye("clipboard.copied"))).subscribe(e)
    }
    function Gn(e, t) {
    ...
    function ur(e) {
        return mn(new URL("sitemap.xml",e)).pipe(m(t=>Ja(t, new URL(e))), ve(()=>I(new Map)))
    }
    function Xa(e, t) {
    ...
    function Za(e) {
        for (let o of ["[data-md-component=announce]", "[data-md-component=container]", "[data-md-component=header-topic]", "[data-md-component=outdated]", "[data-md-component=logo]", "[data-md-component=skip]", ...G("navigation.tabs.sticky") ? ["[data-md-component=tabs]"] : []]) {
            let n = fe(o)
              , i = fe(o, e);
    ...
    function Zn({location$: e, viewport$: t, progress$: r}) {
        ...
        let i = d(document.body, "click").pipe(We(n), v(([p,c])=>Xa(p, c)), pe())
        ...
        S(i, a).subscribe(e);
        let s = e.pipe(Z("pathname"), v(p=>ln(p, {
            progress$: r
        }).pipe(ve(()=>(ct(p, !0),
        M)))), v(Xn), v(Za), pe());
        return S(s.pipe(ee(e, (p,c)=>c)), e.pipe(Z("pathname"), v(()=>e), Z("hash")), e.pipe(K((p,c)=>p.pathname === c.pathname && p.hash === c.hash), v(()=>i), y(()=>history.back()))).subscribe(p=>{
            var c, l;
    ...
    function oi(e) {
        ...
        return n=>{
            ...
            return a=>(0,
            ri.default)(a).replace(i, o).replace(/<\/mark>(\s+)<mark[^>]*>/img, "$1")
        }
    }
    function It(e) {
        return e.type === 1
    ...
    function ni(e, t) {
        let r = vn(e);
        return S(I(location.protocol !== "file:"), Ve("search")).pipe(Ae(o=>o), v(()=>t)).subscribe(({config: o, docs: n})=>r.next({
            type: 0,
            data: {
                config: o,
                docs: n,
                options: {
                    suggest: G("search.suggest")
                }
            }
        })),
        r
    ...
    function ii({document$: e}) {
        ...
        r.pipe(m(n=>new Map(n.map(i=>[`${new URL(`../${i.version}/`,t.base)}`, i]))), v(n=>d(document.body, "click").pipe(b(i=>!i.metaKey && !i.ctrlKey), ee(o), v(([i,a])=>{
            if (i.target instanceof Element) {
                let s = i.target.closest("a");
                if (s && !s.target && n.has(s.href)) {
                    let p = s.href;
                    return !i.target.closest(".md-version") && n.get(p) === a ? M : (i.preventDefault(),
                    I(p))
                }
            }
            return M
            ...
            let {version: a} = n.get(i);
            return ur(new URL(i)).pipe(m(s=>{
                let c = xe().href.replace(t.base, "");
                return s.has(c.split("#")[0]) ? new URL(`../${a}/${c}`,t.base) : new URL(i)
            }
            ))
        }
        )))).subscribe(n=>ct(n, !0)),
    ...
    function ns(e, {worker$: t}) {
        ...
        e.value = r.get("q"),
        e.focus(),
        Ve("search").pipe(Ae(i=>!i)).subscribe(()=>{
            let i = xe();
        ...
        let o = et(e)
          , n = S(t.pipe(Ae(It)), d(e, "keyup"), o).pipe(m(()=>e.value), K());
        return z([n, o]).pipe(m(([i,a])=>({
            value: i,
            focus: a
        })), B(1))
    }
    function ai(e, {worker$: t}) {
        let r = new g
          , o = r.pipe(X(), ne(!0));
        z([t.pipe(Ae(It)), r], (i,a)=>a).pipe(Z("value")).subscribe(({value: i})=>t.next({
            type: 2,
            data: i
        })),
        ...
        d(e.form, "reset").pipe(U(o)).subscribe(()=>e.focus());
        let n = P("header [for=__search]");
        return d(n, "click").subscribe(()=>e.focus()),
        ns(e, {
            worker$: t
        }).pipe(y(i=>r.next(i)), L(()=>r.complete()), m(i=>R({
            ref: e
        }, i)), B(1))
    }
    function si(e, {worker$: t, query$: r}) {
        ...
        Ve("search").subscribe(l=>s.setAttribute("role", l ? "list" : "presentation")),
        o.pipe(ee(r), Ur(t.pipe(Ae(It)))).subscribe(([{items: l},{value: f}])=>{
            switch (l.length) {
            case 0:
                a.textContent = f.length ? ye("search.result.none") : ye("search.result.placeholder");
                break;
            case 1:
                a.textContent = ye("search.result.one");
                break;
            default:
                let u = sr(l.length);
                a.textContent = ye("search.result.other", u)
            }
        }
        );
        let p = o.pipe(y(()=>s.innerHTML = ""), v(({items: l})=>S(I(...l.slice(0, 10)), I(...l.slice(10)).pipe(Ye(4), Vr(n), v(([f])=>f)))), m(Tn), pe());
        return p.subscribe(l=>s.appendChild(l)),
        p.pipe(oe(l=>{
            let f = fe("details", l);
            return typeof f == "undefined" ? M : d(f, "toggle").pipe(U(o), m(()=>f))
        }
        )).subscribe(l=>{
        ...
        t.pipe(b(dr), m(({data: l})=>l)).pipe(y(l=>o.next(l)), L(()=>o.complete()), m(l=>R({
            ref: e
        }, l)))
    }
    ...
    function ci(e, t) {
        ...
        d(e, "click").pipe(U(o)).subscribe(n=>n.preventDefault()),
        is(e, t).pipe(y(n=>r.next(n)), L(()=>r.complete()), m(n=>R({
            ref: e
        }, n)))
    }
    function pi(e, {worker$: t, keyboard$: r}) {
        let o = new g
          , n = Se("search-query")
          , i = S(d(n, "keydown"), d(n, "focus")).pipe(be(se), m(()=>n.value), K());
        return o.pipe(We(i), m(([{suggest: s},p])=>{
            let c = p.split(/([\s-]+)/);
        ...
        t.pipe(b(dr), m(({data: s})=>s)).pipe(y(s=>o.next(s)), L(()=>o.complete()), m(()=>({
            ref: e
        })))
    }
    function li(e, {index$: t, keyboard$: r}) {
        ...
        try {
            ...
            d(e, "click").pipe(b(({target: p})=>p instanceof Element && !!p.closest("a"))).subscribe(()=>Je("search", !1)),
            ...
            return S(s, si(a, {
                worker$: n,
                query$: s
            })).pipe(Pe(...ae("search-share", e).map(p=>ci(p, {
                query$: s
            })), ...ae("search-suggest", e).map(p=>pi(p, {
                worker$: n,
                keyboard$: r
            }))))
        } catch (n) {
    ...
    function mi(e, {index$: t, location$: r}) {
        return z([t, r.pipe(Q(xe()), b(o=>!!o.searchParams.get("h")))]).pipe(m(([o,n])=>oi(o.config)(n.searchParams.get("h"))), m(o=>{
            var a;
            let n = new Map
            ...
            for (let[s,p] of n) {
                let {childNodes: c} = E("span", null, p);
    ...
    function as(e, {viewport$: t, main$: r}) {
        ...
        return z([r, t]).pipe(m(([{offset: i, height: a},{offset: {y: s}}])=>(a = a + Math.min(n, Math.max(0, s - i)) - n,
        {
            height: a,
            locked: s >= i + n
    ...
    function Jr(e, o) {
        ...
        return C(()=>{
            let s = new g
              , p = s.pipe(X(), ne(!0))
              , c = s.pipe(Le(0, me));
            return c.pipe(ee(t)).subscribe({
                next([{height: l},{height: f}]) {
                    i.style.height = `${l - 2 * a - 1}px`,
                    e.style.top = `${f}px`
                },
                complete() {
                    i.style.height = "",
            ...
            ue($("label[tabindex]", e)).pipe(oe(l=>d(l, "click").pipe(be(se), m(()=>l), U(p)))).subscribe(l=>{
                let f = P(`[id="${l.htmlFor}"]`);
                P(`[aria-labelledby="${l.id}"]`).setAttribute("aria-expanded", `${f.checked}`)
            }
            ),
            as(e, r).pipe(y(l=>s.next(l)), L(()=>s.complete()), m(l=>R({
                ref: e
            }, l)))
        }
        )
    ...
    function fi(e, t) {
        if (typeof t != "undefined") {
            ...
            return Ct(Ne(`${r}/releases/latest`).pipe(ve(()=>M), m(o=>({
                version: o.tag_name
            })), Be({})), Ne(r).pipe(ve(()=>M), m(o=>({
                stars: o.stargazers_count,
                forks: o.forks_count
            })), Be({}))).pipe(m(([o,n])=>R(R({}, o), n)))
        } else {
            let r = `https://api.github.com/users/${e}`;
            return Ne(r).pipe(m(o=>({
    ...
    function ui(e, t) {
        ...
        return Ne(r).pipe(ve(()=>M), m(({star_count: o, forks_count: n})=>({
            stars: o,
            forks: n
        })), Be({}))
    }
    ...
    function cs(e) {
        return ss || (ss = C(()=>{
            ...
            return di(e.href).pipe(y(o=>__md_set("__source", o, sessionStorage)))
        }
        ).pipe(ve(()=>M), b(t=>Object.keys(t).length > 0), m(t=>({
            facts: t
        })), B(1)))
    }
    function hi(e) {
        ...
        return C(()=>{
            ...
            cs(e).pipe(y(o=>r.next(o)), L(()=>r.complete()), m(o=>R({
                ref: e
            }, o)))
        }
        )
    ...
    function bi(e, t) {
        return C(()=>{
            ...
            (G("navigation.tabs.sticky") ? I({
                hidden: !1
            }) : ps(e, t)).pipe(y(o=>r.next(o)), L(()=>r.complete()), m(o=>R({
                ref: e
            }, o)))
        }
        )
    ...
    function ls(e, {viewport$: t, header$: r}) {
        ...
        let i = r.pipe(Z("height"), m(({height: s})=>{
            let p = Se("main")
              , c = P(":scope > :first-child", p);
            return s + .8 * (c.offsetTop - p.offsetTop)
        }
        ), pe());
        return ge(document.body).pipe(Z("height"), v(s=>C(()=>{
            let p = [];
        ...
        ).pipe(m(p=>new Map([...p].sort(([,c],[,l])=>c - l))), We(i), v(([p,c])=>t.pipe(jr(([l,f],{offset: {y: u}, size: h})=>{
        ...
        , [[], [...p]]), K((l,f)=>l[0] === f[0] && l[1] === f[1])))))).pipe(m(([s,p])=>({
            ...
            prev: [],
            next: []
        }), Ye(2, 1), m(([s,p])=>s.prev.length < p.prev.length ? {
    ...
    function vi(e, {viewport$: t, header$: r, main$: o, target$: n}) {
        return C(()=>{
            ...
            G("toc.follow")) {
                let s = S(t.pipe(_e(1), m(()=>{}
                )), t.pipe(_e(250), m(()=>"smooth")));
                i.pipe(b(({prev: p})=>p.length > 0), We(o.pipe(be(se))), ee(s)).subscribe(([[{prev: p}],c])=>{
                    let[l] = p[p.length - 1];
                    if (l.offsetHeight) {
                        let f = cr(l);
                        if (typeof f != "undefined") {
            ...
            return G("navigation.tracking") && t.pipe(U(a), Z("offset"), _e(250), Ce(1), U(n.pipe(Ce(1))), at({
                delay: 250
            }), ee(i)).subscribe(([,{prev: s}])=>{
                let p = xe()
                  , c = s[s.length - 1];
                if (c && c.length) {
                    let[l] = c
            ...
            ls(e, {
                viewport$: t,
                header$: r
            }).pipe(y(s=>i.next(s)), L(()=>i.complete()), m(s=>R({
                ref: e
            }, s)))
        }
        )
    ...
    function ms(e, {viewport$: t, main$: r, target$: o}) {
        let n = t.pipe(m(({offset: {y: a}})=>a), Ye(2, 1), m(([a,s])=>a > s && s > 0), K())
          , i = r.pipe(m(({active: a})=>a));
        return z([i, n]).pipe(m(([a,s])=>!(a && s)), K(), U(o.pipe(Ce(1))), ne(!0), at({
            delay: 250
        }), m(a=>({
            hidden: a
        })))
    ...
    function xi({document$: e, viewport$: t}) {
        e.pipe(v(()=>$(".md-ellipsis")), oe(r=>Tt(r).pipe(U(e.pipe(Ce(1))), b(o=>o), m(()=>r), we(1))), b(r=>r.offsetWidth < r.scrollWidth), oe(r=>{
            let o = r.innerText
              , n = r.closest("a") || r;
            return n.title = o,
            pt(n, {
                viewport$: t
            }).pipe(U(e.pipe(Ce(1))), L(()=>n.removeAttribute("title")))
        }
        )).subscribe(),
        e.pipe(v(()=>$(".md-status")), oe(r=>pt(r, {
            viewport$: t
        }))).subscribe()
    }
    function yi({document$: e, tablet$: t}) {
        e.pipe(v(()=>$(".md-toggle--indeterminate")), y(r=>{
            r.indeterminate = !0,
            r.checked = !1
        }
        ), oe(r=>d(r, "change").pipe(Dr(()=>r.classList.contains("md-toggle--indeterminate")), m(()=>r))), ee(t)).subscribe(([r,o])=>{
    ...
    function Ei({document$: e}) {
        e.pipe(v(()=>$("[data-md-scrollfix]")), y(t=>t.removeAttribute("data-md-scrollfix")), b(fs), oe(t=>d(t, "touchstart").pipe(m(()=>t)))).subscribe(t=>{
            let r = t.scrollTop;
    ...
    function wi({viewport$: e, tablet$: t}) {
        z([Ve("search"), t]).pipe(m(([r,o])=>r && !o), v(r=>I(r).pipe(Ge(r ? 400 : 100))), ee(e)).subscribe(([r,{offset: {y: o}}])=>{
            if (r)
    ...
    function us() {
        return location.protocol === "file:" ? Et(`${new URL("search/search_index.js",Xr.base)}`).pipe(m(()=>__index), B(1)) : Ne(new URL("search/search_index.json",Xr.base))
    }
    ...
    var to = new g;
    G("navigation.instant") && Zn({
        location$: jt,
        viewport$: Oe,
        progress$: to
    }).subscribe(rt);
    var Ti;
    ((Ti = Xr.version) == null ? void 0 : Ti.provider) === "mike" && ii({
        document$: rt
    });
    S(jt, Ot).pipe(Ge(125)).subscribe(()=>{
        Je("drawer", !1),
        Je("search", !1)
    }
    );
    ...
    var tt = Nn(Se("header"), {
      ...
      , Ft = rt.pipe(m(()=>Se("main")), v(e=>Qn(e, {
        viewport$: Oe,
        header$: tt
    })), B(1))
      , ds = S(...ae("consent").map(e=>xn(e, {
        target$: Ot
    })), ...ae("dialog").map(e=>Dn(e, {
        alert$: eo
    })), ...ae("header").map(e=>zn(e, {
        viewport$: Oe,
        header$: tt,
        main$: Ft
    })), ...ae("palette").map(e=>Kn(e)), ...ae("progress").map(e=>Yn(e, {
        progress$: to
    })), ...ae("search").map(e=>li(e, {
        index$: Mi,
        keyboard$: Zr
    })), ...ae("source").map(e=>hi(e)))
      , hs = C(()=>S(...ae("announce").map(e=>gn(e)), ...ae("content").map(e=>Un(e, {
        viewport$: Oe,
        target$: Ot,
        print$: Oi
    })), ...ae("content").map(e=>G("search.highlight") ? mi(e, {
        index$: Mi,
        location$: jt
    }) : M), ...ae("header-title").map(e=>qn(e, {
        viewport$: Oe,
        header$: tt
    })), ...ae("sidebar").map(e=>e.getAttribute("data-md-type") === "navigation" ? Nr(Si, ()=>Jr(e, {
        viewport$: Oe,
        header$: tt,
        main$: Ft
    })) : Nr(hr, ()=>Jr(e, {
